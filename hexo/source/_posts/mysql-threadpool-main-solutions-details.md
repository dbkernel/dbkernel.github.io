...
![MariaDB Sysbench oltp_rw 性能](mariadb-threadpool-sysbench-oltp-rw.png "MariaDB Sysbench oltp_rw 性能")
...
| `thread_pool_exact_stats` <br>是否使用高精度时间戳                                                                                                   | 有                                                                         | 无      | 无             | 无                                                        | 无                                               |
